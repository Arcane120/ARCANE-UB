...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest Github Build (Anmol-dot283/Black Arcane)**",
        ...
        "__INFO:Black Arcane:Logged in as 557667062__",
        "__INFO:Black Arcane:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
