...
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        if lightningusername is None or input_str == "text":
            ...
            light_help_strin = """**Black Arcane Heres With The Detailed Help For CMDs** 😉😉 !\n If Faced Any Bug Please Give The Feed Back at [Arcane Support](https://t.me/lightning_support_group):"""
