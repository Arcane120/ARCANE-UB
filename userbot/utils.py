...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            ftext += "--------BEGIN Arcane USERBOT TRACEBACK LOG--------"
            ftext += "\nDate: " + date
...
def start_assistant(shortname):
    if shortname.startswith("__"):
        ...
        spec.loader.exec_module(mod)
        sys.modules[
            "userbot.plugins.assistant" + "Initialising Arcane" + shortname
        ] = mod
        sedprint.info("Arcane Has imported " + shortname)
...
def load_assistant(shortname):
    if shortname.startswith("__"):
        ...
        mod = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(mod)
        print("Initialising Arcane.")
        print("Arcane - Imported " + shortname)
    else:
        import importlib
        import sys
        from pathlib import Path
        ...
        print("Arcane Has imported " + shortname)
